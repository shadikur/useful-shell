...
apt update -y && apt -y upgrade && apt install build-essential -y && apt install wget git zip sudo unzip vim nano dialog curl lsb-release software-properties-common -y
